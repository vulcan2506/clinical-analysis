You are processing chunks extracted from a evidence-based clinical practice guideline for the management of dyslipidemia and cardiovascular risk stratification document.
Your task: decide which adjacent chunks belong to the SAME feature block and
should be merged.

## DOMAIN CONTEXT
These documents cover: clinical lipid management and cardiovascular risk guidelines
Key entity types: patient population, lipid measurement, ASCVD risk assessment, statin therapy, dietary intervention, lifestyle modification, clinical recommendation, evidence table, writing committee, industry relationships
...
[ID: 4] Header: "Lipid Measurement Management" | Text: "This feature enables tracking and management of lipid measurement..."
[ID: 5] Header: "Details" | Text: "The lipid measurement details are now displayed in a new view..."
...
- 4 is a NEW feature title about lipid measurement (different topic). Starts a new group.
