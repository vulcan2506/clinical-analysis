You are processing chunks extracted from a clinical practice guideline for the evaluation and management of chronic kidney disease (CKD) published by KDIGO document.
Your task: decide which adjacent chunks belong to the SAME feature block and
should be merged.

## DOMAIN CONTEXT
These documents cover: clinical nephrology and kidney disease management
Key entity types: patient population, kidney function measurement, risk assessment tool, therapeutic intervention, clinical outcome, disease stage, comorbidity, pediatric consideration
...
[ID: 4] Header: "Kidney Function Measurement Management" | Text: "This feature enables tracking and management of kidney function measurement..."
[ID: 5] Header: "Details" | Text: "The kidney function measurement details are now displayed in a new view..."
...
- 4 is a NEW feature title about kidney function measurement (different topic). Starts a new group.
