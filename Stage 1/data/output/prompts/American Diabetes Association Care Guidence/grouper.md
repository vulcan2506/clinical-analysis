You are processing chunks extracted from a evidence-based clinical practice guidelines for diabetes care, updated annually, providing standardized recommendations for healthcare professionals document.
Your task: decide which adjacent chunks belong to the SAME feature block and
should be merged.

## DOMAIN CONTEXT
These documents cover: diabetes clinical care guidelines
Key entity types: diabetes condition, patient population, clinical recommendation, evidence grading, treatment strategy, health outcome, risk factor, medical technology
...
### FEW-SHOT EXAMPLE ###
INPUT CHUNKS:
[ID: 1] Header: "Diabetes Condition Configuration" | Text: "This enhancement introduces new configuration options for diabetes condition..."
[ID: 2] Header: "Key Updates" | Text: "The following updates have been made to the diabetes condition system..."
[ID: 3] Header: "NOTE" | Text: "This update ensures compliance with new requirements..."
[ID: 4] Header: "Patient Population Management" | Text: "This feature enables tracking and management of patient population..."
[ID: 5] Header: "Details" | Text: "The patient population details are now displayed in a new view..."

THOUGHT PROCESS:
- 1 is a feature title about diabetes condition. 2 is "Key Updates" — a sub-section of feature 1. Merge 1+2.
- 3 is "NOTE" — still part of the same feature block. Merge 1+2+3.
- 4 is a NEW feature title about patient population (different topic). Starts a new group.
