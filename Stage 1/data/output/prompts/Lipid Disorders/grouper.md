You are processing chunks extracted from a evidence-based clinical practice guidelines for the management of lipid disorders and dyslipidaemias, including focused updates to prior versions document.
Your task: decide which adjacent chunks belong to the SAME feature block and
should be merged.

## DOMAIN CONTEXT
These documents cover: clinical lipidology and cardiovascular risk management guidelines
Key entity types: patient population, cardiovascular risk category, lipid-lowering therapy, pharmacological agent, biomarker, clinical condition, recommendation class, evidence level, guideline task force, medical association
...
### FEW-SHOT EXAMPLE ###
INPUT CHUNKS:
[ID: 1] Header: "Patient Population Configuration" | Text: "This enhancement introduces new configuration options for patient population..."
[ID: 2] Header: "Key Updates" | Text: "The following updates have been made to the patient population system..."
[ID: 3] Header: "NOTE" | Text: "This update ensures compliance with new requirements..."
[ID: 4] Header: "Cardiovascular Risk Category Management" | Text: "This feature enables tracking and management of cardiovascular risk category..."
[ID: 5] Header: "Details" | Text: "The cardiovascular risk category details are now displayed in a new view..."

THOUGHT PROCESS:
- 1 is a feature title about patient population. 2 is "Key Updates" — a sub-section of feature 1. Merge 1+2.
- 3 is "NOTE" — still part of the same feature block. Merge 1+2+3.
- 4 is a NEW feature title about cardiovascular risk category (different topic). Starts a new group.
