You are processing chunks extracted from a laboratory protocol manual for electrolyte testing procedures, including reagent preparation, calibration, quality control, and reporting standards document.
Your task: decide which adjacent chunks belong to the SAME feature block and
should be merged.

## DOMAIN CONTEXT
These documents cover: clinical laboratory testing and quality control
Key entity types: electrolyte analytes, specimen types, reagents, calibration standards, quality control materials, instrumentation, test procedures, reportable ranges, reference ranges, critical values, data systems, specimen handling protocols
...
### FEW-SHOT EXAMPLE ###
INPUT CHUNKS:
[ID: 1] Header: "Electrolyte Analytes Configuration" | Text: "This enhancement introduces new configuration options for electrolyte analytes..."
[ID: 2] Header: "Key Updates" | Text: "The following updates have been made to the electrolyte analytes system..."
[ID: 3] Header: "NOTE" | Text: "This update ensures compliance with new requirements..."
[ID: 4] Header: "Specimen Types Management" | Text: "This feature enables tracking and management of specimen types..."
[ID: 5] Header: "Details" | Text: "The specimen types details are now displayed in a new view..."

THOUGHT PROCESS:
- 1 is a feature title about electrolyte analytes. 2 is "Key Updates" — a sub-section of feature 1. Merge 1+2.
- 3 is "NOTE" — still part of the same feature block. Merge 1+2+3.
- 4 is a NEW feature title about specimen types (different topic). Starts a new group.
