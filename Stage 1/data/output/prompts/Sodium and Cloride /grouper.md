You are processing chunks extracted from a educational reference on sodium, potassium, and chloride physiology, pathology, and diagnostic interpretation for veterinary clinicians and laboratory diagnosticians document.
Your task: decide which adjacent chunks belong to the SAME feature block and
should be merged.

## DOMAIN CONTEXT
These documents cover: veterinary clinical pathology and electrolyte physiology
Key entity types: electrolyte, disease_condition, diagnostic_table, physiologic_process, laboratory_finding, clinical_symptom, metabolic_pathway, organ_system
...
### FEW-SHOT EXAMPLE ###
INPUT CHUNKS:
[ID: 1] Header: "Electrolyte Configuration" | Text: "This enhancement introduces new configuration options for electrolyte..."
[ID: 2] Header: "Key Updates" | Text: "The following updates have been made to the electrolyte system..."
[ID: 3] Header: "NOTE" | Text: "This update ensures compliance with new requirements..."
[ID: 4] Header: "Disease Condition Management" | Text: "This feature enables tracking and management of disease_condition..."
[ID: 5] Header: "Details" | Text: "The disease_condition details are now displayed in a new view..."

THOUGHT PROCESS:
- 1 is a feature title about electrolyte. 2 is "Key Updates" — a sub-section of feature 1. Merge 1+2.
- 3 is "NOTE" — still part of the same feature block. Merge 1+2+3.
- 4 is a NEW feature title about disease_condition (different topic). Starts a new group.
