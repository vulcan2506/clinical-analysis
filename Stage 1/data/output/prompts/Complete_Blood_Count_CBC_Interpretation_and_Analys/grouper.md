You are processing chunks extracted from a comprehensive review and analysis guide for Complete Blood Count (CBC) interpretation and quality assurance in medical laboratory practice document.
Your task: decide which adjacent chunks belong to the SAME feature block and
should be merged.

## DOMAIN CONTEXT
These documents cover: clinical hematology laboratory diagnostics
Key entity types: hematology analyzer, red blood cell parameter, white blood cell parameter, platelet parameter, anemia classification, leukocyte disorder, platelet disorder, quality control metric
...
### FEW-SHOT EXAMPLE ###
INPUT CHUNKS:
[ID: 1] Header: "Hematology Analyzer Configuration" | Text: "This enhancement introduces new configuration options for hematology analyzer..."
[ID: 2] Header: "Key Updates" | Text: "The following updates have been made to the hematology analyzer system..."
[ID: 3] Header: "NOTE" | Text: "This update ensures compliance with new requirements..."
[ID: 4] Header: "Red Blood Cell Parameter Management" | Text: "This feature enables tracking and management of red blood cell parameter..."
[ID: 5] Header: "Details" | Text: "The red blood cell parameter details are now displayed in a new view..."

THOUGHT PROCESS:
- 1 is a feature title about hematology analyzer. 2 is "Key Updates" — a sub-section of feature 1. Merge 1+2.
- 3 is "NOTE" — still part of the same feature block. Merge 1+2+3.
- 4 is a NEW feature title about red blood cell parameter (different topic). Starts a new group.
